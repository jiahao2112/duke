...
public class DeadlineCheckerTests {
    ...
    class CheckDeadlineByKeyword_Test {
        ...
        @Test
        @DisplayName("Success")
        public void checkDeadlineByKeywordTest_Success() {
        ...
        public void checkDeadlineByKeywordTest_MissingByKeywordException() {
            ...
            assertEquals("Missing /by keyword in deadline command. Usage: deadline <task name> /by <dd/MM/yyyy> <HH:mm (24-hour)>"
    ...
    class CheckDeadlineFormat_Test {
        ...
        public void checkDeadlineFormat_MissingTaskNameException() {
            formatTest.add("");
            formatTest.add("22/10/22 00:00");
            ...
            assertEquals("Missing task name in deadline command. Usage: deadline <task name> /by <dd/MM/yyyy> <HH:mm (24-hour)>"
                    , deadlineException.getMessage());
        }

        @Test
        @DisplayName("Throws MissingDeadlineByException")
        public void checkDeadlineFormat_MissingDeadlineByException() {
            formatTest.add("task");
            formatTest.add("");

            DeadlineException deadlineException = assertThrows(DeadlineException.MissingDeadlineByException.class
                    , () -> DeadlineChecker.checkDeadlineFormat(formatTest));
            assertEquals("Missing by-date and time in deadline command. Usage: deadline <task name> /by <dd/MM/yyyy> <HH:mm (24-hour)>"
                    , deadlineException.getMessage());
        }
    }
}
